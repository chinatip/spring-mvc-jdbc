package com.chinatip.assignment3.controller;
...
import com.chinatip.assignment3.database.Pattern;
import com.chinatip.assignment3.database.PatternJDBCTemplate;
...
public class AppController {
	...
	public ModelAndView addNewPatternSubmit(@ModelAttribute("pattern") Pattern pattern) {
		...
		System.out.println("[BeforeIF]" + isValid);
		if( isValid ) {
			pattern.setId(patternJDBCTemplate.listPatterns().size() + 1);
			System.out.println(pattern.toString());
			System.out.println("INIF : " + pattern.getName() +  pattern.getGroup() +  pattern.getImplementation());
